            ...
            if($list) {
                foreach ($list as $cell) {
                    if($cell['ID'] == $ID) {
                        ...
                        $page = str_replace('<input type="file" id="Immagine" name="Immagine" accept="image/*" title="Immagine o foto del risultato finale della ricetta" aria-label="Foto della ricetta"/>', '</br> <img src="'.$cell['Immagine'].'" alt="'.$cell['AltImmagine'].'">',$page);
